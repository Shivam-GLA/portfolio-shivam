...
export default function Dashboard() {
  ...
  let quotes = [
    ...
    {
      text: "True guidance is like a small lamp in darkness.",
      author: "B.K.S. Iyengar",
    },
    {
      text: "Self-belief and hard work always earn you success.",
      author: "Virat Kohli",
    },
    {
    ...
    {
      text: "You are never too old to learn.",
      author: "Swami Vivekananda",
    },
    {
      text: "Great thoughts come from the heart.",
      author: "Swami Vivekananda",
    },
  ];
